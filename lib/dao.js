...
//exports.getUserLatestEvent = function (user_id){
...
//                    relatedBehavior: result.get("relatedBehavior"),
//                    eventType:       result.get("eventType")
//                };
//                events.push(event);
//            });
//            console.log(JSON.stringify(events));
//            return AV.Promise.as(events);
//        },
//        function (error){
//            return AV.Promise.error(error);
//        }
...
exports.addEvent = function(user_id, event_type, start_time, end_time, behavior_id_list){
    var event = new Event();
    var user  = AV.Object.createWithoutData("_User", user_id);
