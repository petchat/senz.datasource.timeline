...
var _request_info = {
    "test": {
        ...
        "log_rawsenzes": {
            "url": "http://api.trysenz.com/test/middleware/log/rawsenz/",
            "headers": {
        ...
        "rawsenzes_refinedsenzes": {
            "url": "http://api.trysenz.com/test/middleware/rawsenz/refinedsenzes/",
            "headers": {
        ...
        "probsenzes_multisenzes": {
            "url": "http://api.trysenz.com/test/middleware/probsenzlist/multisenzlist/",
            "headers": {
        ...
        "userbehavior_event": {
            ...
            "url": "http://api.trysenz.com/test/users/behavior/predict/",
            "headers": {
        ...
        "notification": {
            "url": "http://api.trysenz.com/test/sdk/notification/",
            "headers": {
                "Content-Type": "application/json; charset=utf-8",
    ...
    "prod": {
        ...
        // Middleware from log to raw senzes.
        "log_rawsenzes": {
            "url": "http://api.trysenz.com/middleware/log/rawsenz/",
            "headers": {
                "X-senz-Auth": "5548eb2ade57fc001b000001fbaca010e5a8436d7355e09be7a2d436"
            }
        },
        // Middleware from raw senzes to refined senzes.
        "rawsenzes_refinedsenzes": {
            "url": "http://api.trysenz.com/middleware/rawsenz/refinedsenzes/",
            "headers": {
                "X-senz-Auth": "5548eb2ade57fc001b0000010025f1061a8a4a93601be2c05f83d70c"
            }
        },
        // Middleware from prob senzes to multiple senzes.
        "probsenzes_multisenzes": {
            "url": "http://api.trysenz.com/middleware/probsenzlist/multisenzlist/",
            "headers": {
                "X-senz-Auth": "5548eb2ade57fc001b0000015ed2dae1b3a14e217f3ffd5a9e9f6735"
            }
        },
        ...
        "userbehavior_event": {
            //"url": "http://120.27.30.239:13418/predict/",
            "url": "http://api.trysenz.com/users/behavior/predict/",
            "headers": {
                "X-senz-Auth": "5548eb2ade57fc001b000001fe069319f82742695d9584af4f43d771",
                "Content-Type": "application/json; charset=utf-8"
            }
        ...
        "notification": {
            "url": "http://api.trysenz.com/sdk/notification/",
            "headers": {
                "Content-Type": "application/json; charset=utf-8",
                "X-senz-Auth": "5548eb2ade57fc001b0000018f8b08f5a0ea4120775a41f8396783d2"
            }
...
console.log("Current APP_ID:" + APP_ID);
console.log("Current APP_KEY:" + APP_KEY);
console.log("Current MASTER_KEY:" + MASTER_KEY);
