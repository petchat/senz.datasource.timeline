...
var _get_post_wilddog_config = function(user_id, situation, sub_situtation){
    ...
    if(wd_strategy[situation] && wd_strategy[situation][sub_situtation]){
        var level = wd_strategy[situation][sub_situtation].level;
        var expired = wd_strategy[situation][sub_situtation].expired;
