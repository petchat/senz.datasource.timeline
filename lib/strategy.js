...
var wilddog_config_posted_flag = {};
var _calculate_config = function(user_id, strategy, situation, sub_situation){
    ...
    if(wilddog_config_posted_flag[user_id]['sub_situation'] != sub_situation){
        wilddog_config_posted_flag[user_id]['sub_situation'] = sub_situation;
        if(strategy[situation] && strategy[situation][sub_situation]){
            console.log("================================");
                    ...
                    function(){
                        timer.start(user_id, expired*1000)
                            .then(
                                function(){
                                    console.log('Timeout!!!');
                                    wilddog_config_posted_flag[user_id]['sub_situation'] = undefined;
