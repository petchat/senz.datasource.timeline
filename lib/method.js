            ...
            users_list.forEach(function (user) {
                ...
                if (location_list.length >= 1) {
                    ...
                    location_list.forEach(function (location){
                        locations.push(location["timestamp"]);
                    });
                    var motions = [];
                    motion_list.forEach(function (motion){
                        motions.push(motion["timestamp"]);
                    });
                    var sounds = [];
                    sound_list.forEach(function (sound){
                        sounds.push(sound["timestamp"]);
                    });
