...
exports.behaviorCollector = function (behavior, scale){
    ...
    var start_scale_value = util.calculateTimeZone(behavior[0]["timestamp"], scale);
    var end_scale_value = util.calculateTimeZone(behavior[behavior.length - 1]["timestamp"], scale);
    console.log(start_scale_value);
    console.log(end_scale_value);
    var data = {
        "scaleType": scale,
        "startScaleValue": 30,
        "endScaleValue": 33,
